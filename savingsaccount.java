...
public class SavingsAccountApp {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(CSV_FILE))) {
            ...
            if (!accountFound) {
                ...
                savings = createNewAccount(scan, userID); // Create a new account if none found
            }
        } catch (IOException | ParseException e) {
            System.out.println("Error loading account, creating a new one...");
            savings = createNewAccount(scan, userID); // Fallback to create a new account
        }
    ...
    private static SavingsAccount createNewAccount(Scanner scan, String userID) {
...
class SavingsAccount {
    ...
    public static SavingsAccount loadByAccountNumber(String accountNumber) {
        try (BufferedReader br = new BufferedReader(new FileReader("savingsaccount.csv"))) {
            String line;
            br.readLine(); // skip header
            while ((line = br.readLine()) != null) {
                String[] data = line.split(",");
