...
class CreditCard {
    ...
    // Main method (typically moved to a separate class in a real application)
    ...
    public static void main(String[] args) {
        ...
        creditCard.menu(scanner);

    }

    // Menu method with improved error handling
    ...
    private void displayMenuOptions() {
        ...
        System.out.println("\nWelcome. Please type the relevant number below:");

        System.out.println("1. Apply for Credit");

        System.out.println("2. Pay Using Credit Card");

        System.out.println("3. Review Bank Statement");

        System.out.println("4. Pay Bank Statement");
